...
export function CreateStory({
  ...
  return <motion.div initial={{
    ...
    opacity: 0
      ...
      {/* Content */}
      <div className="flex-1 p-4 flex-row flex items-start justify-center px-[16px] py-[16px]">
        {preview ? <div className="relative max-w-sm w-full aspect-[9/16] rounded-2xl overflow-hidden bg-black">
          ...
          setPreview(null);
            ...
            <div onClick={() => fileInputRef.current?.click()} className="w-48 h-48 rounded-full bg-muted flex items-center justify-center cursor-pointer hover:bg-muted/80 transition-colors">
