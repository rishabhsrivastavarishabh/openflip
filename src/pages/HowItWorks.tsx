  ...
  return (
    <MainLayout>
      <div className="max-w-2xl mx-auto p-4">
        <Seo title="How messaging works — Openflip" description="Learn how Openflip messaging works: end-to-end encrypted chats, per-device keys, disappearing and view-once media, voice notes, and secure group conversations." path="/how-it-works" />
