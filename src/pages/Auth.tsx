...
export default function AuthPage() {
  ...
  // ---- Passwordless sign-in via emailed link ----
          ...
          <AnimatePresence mode="wait">
            {mode === 'forgot' ? (
              ...
              <motion.div key="signin" {...stepVariants} className="space-y-6">
                ...
                <Button type="button" variant="outline" size="lg" className="w-full" disabled={loading} onClick={handleMagicLink}>
                  <Mail className="mr-2 h-5 w-5" />Email me a sign-in link
                </Button>
