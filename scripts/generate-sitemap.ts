...
const staticEntries: SitemapEntry[] = [
  ...
  { path: "/about", changefreq: "monthly", priority: "0.8", image: ICON, imageTitle: "About Openflip — Social Networking Platform" },
  { path: "/features", changefreq: "monthly", priority: "0.8", image: ICON, imageTitle: "Openflip Features — Posts, Reels, Stories & Chat" },
  { path: "/creators", changefreq: "monthly", priority: "0.7", image: ICON, imageTitle: "Openflip for Creators — Studio & Monetisation" },
  { path: "/community", changefreq: "monthly", priority: "0.6", image: ICON, imageTitle: "Openflip Community Guidelines" },
  { path: "/help", changefreq: "monthly", priority: "0.7", image: ICON, imageTitle: "Openflip Help Centre & FAQ" },
  { path: "/contact", changefreq: "yearly", priority: "0.5", image: ICON, imageTitle: "Contact Openflip Support" },
